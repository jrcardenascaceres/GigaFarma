        ...
        <section class="bg-light">
            <div class="container py-4">
                ...
                <div class="float-inline">
                    <a href="forms/form_laboratorio.jsp?accion=registrar" id="regLaboratorio" class="btn btn-success"><i class="fas fa-plus"></i> Agregar</a>
                </div>
                <hr>
                <table id="tblProductos" class="display" style="width:100%">
                    ...
                    <tbody>
                        <%
                            ...
                            ArrayList<Laboratorio> laboratorios = new ArrayList<>(n.lisLaboratorio());
                            for (Laboratorio laboratorio : laboratorios) {
                                int idLaboratorio = laboratorio.getID_LABORATORIO();
                        %>
                        <tr>
                            <td><%=idLaboratorio%></td>
                            <td><%=laboratorio.getNOMBRE()%></td>
                            <td><%=laboratorio.getDESCRIPCION()%></td>
                            <td>
                                <div class="text-center">
                                    <a href="forms/form_laboratorio.jsp?accion=actualizar&idLaboratorio=<%=idLaboratorio%>" title="Editar" class="actLaboratorio"><i class="fas fa-edit btn btn-success "></i></a>
                                    <button  value="<%=idLaboratorio%>" class="eliLaboratorio"><i class="fas fa-trash-alt btn btn-danger"></i></button>
                                </div>
                            </td>
                        </tr>
                        <%
